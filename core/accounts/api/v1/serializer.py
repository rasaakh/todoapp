...
class CastumAuthTokenSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        ...
        if username and password:
            ...
            if not user.is_verified:
                raise serializers.ValidationError({"detaile": "user is not verified"})
        else:
...
class ActivationResendApiviewSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        ...
        try:
            ...
            raise serializers.ValidationError({"detaile": "user dos not exist"})

        if user_obj.is_verified:
            raise serializers.ValidationError({"detaile": "user acsses is verified"})
